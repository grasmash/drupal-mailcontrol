 ...
 * ABOUT
 */
Have 100% control over the default mails sent by Drupal 7 out of the box.

This small module extends original Drupal 7 account settings page with the ability to turn ON/OFF all standard mails. By default Drupal 7 provides no option to disable welcome emails, account cancellation confirmation or password reset.
